...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, "/*! modern-normalize v1.0.0 | MIT License | https://github.com/sindresorhus/modern-normalize */:root{-moz-tab-size:4;-o-tab-size:4;tab-size:4}html{line-height:1.15;-webkit-text-size-adjust:100%}body{margin:0;font-family:system-ui,-apple-system,Segoe UI,Roboto,Ubuntu,Cantarell,Noto Sans,sans-serif,\"Segoe UI\",Helvetica,Arial,\"Apple Color Emoji\",\"Segoe UI Emoji\"}hr{height:0;color:inherit}abbr[title]{-webkit-text-decoration:underline dotted;text-decoration:underline dotted}b,strong{font-weight:bolder}code,kbd,pre,samp{font-family:ui-monospace,SFMono-Regular,Consolas,\"Liberation Mono\",Menlo,monospace;font-size:1em}small{font-size:80%}sub,sup{font-size:75%;line-height:0;position:relative;vertical-align:baseline}sub{bottom:-.25em}sup{top:-.5em}table{text-indent:0;border-color:inherit}button,input,optgroup,select,textarea{font-family:inherit;font-size:100%;line-height:1.15;margin:0}button,select{text-transform:none}[type=button],[type=reset],button{-webkit-appearance:button}legend{padding:0}progress{vertical-align:baseline}summary{display:list-item}blockquote,dd,dl,figure,h1,h2,h3,h4,h5,h6,hr,p,pre{margin:0}button{background-color:transparent;background-image:none}button:focus{outline:1px dotted;outline:5px auto -webkit-focus-ring-color}fieldset,ol,ul{margin:0;padding:0}ol,ul{list-style:none}html{font-family:ui-sans-serif,system-ui,-apple-system,Segoe UI,Roboto,Ubuntu,Cantarell,Noto Sans,sans-serif,BlinkMacSystemFont,\"Segoe UI\",\"Helvetica Neue\",Arial,\"Noto Sans\",\"Apple Color Emoji\",\"Segoe UI Emoji\",\"Segoe UI Symbol\",\"Noto Color Emoji\";line-height:1.5}body{font-family:inherit;line-height:inherit}*,:after,:before{box-sizing:border-box;border:0 solid}hr{border-top-width:1px}img{border-style:solid}textarea{resize:vertical}input::-moz-placeholder,textarea::-moz-placeholder{color:#9ca3af}input:-ms-input-placeholder,textarea:-ms-input-placeholder{color:#9ca3af}input::placeholder,textarea::placeholder{color:#9ca3af}button{cursor:pointer}table{border-collapse:collapse}h1,h2,h3,h4,h5,h6{font-size:inherit;font-weight:inherit}a{color:inherit;text-decoration:inherit}button,input,optgroup,select,textarea{padding:0;line-height:inherit;color:inherit}code,kbd,pre,samp{font-family:ui-monospace,SFMono-Regular,Menlo,Monaco,Consolas,\"Liberation Mono\",\"Courier New\",monospace}audio,canvas,embed,iframe,img,object,svg,video{display:block;vertical-align:middle}img,video{max-width:100%;height:auto}.container{width:100%}@media (min-width:640px){.container{max-width:640px}}@media (min-width:768px){.container{max-width:768px}}@media (min-width:1024px){.container{max-width:1024px}}@media (min-width:1280px){.container{max-width:1280px}}@media (min-width:1536px){.container{max-width:1536px}}.space-y-sp>:not([hidden])~:not([hidden]){--tw-space-y-reverse:0;margin-top:calc(8px*(1 - var(--tw-space-y-reverse)));margin-bottom:calc(8px*var(--tw-space-y-reverse))}.space-x-btn>:not([hidden])~:not([hidden]){--tw-space-x-reverse:0;margin-right:calc(58px*var(--tw-space-x-reverse));margin-left:calc(58px*(1 - var(--tw-space-x-reverse)))}.space-x-icon-btn>:not([hidden])~:not([hidden]){--tw-space-x-reverse:0;margin-right:calc(11px*var(--tw-space-x-reverse));margin-left:calc(11px*(1 - var(--tw-space-x-reverse)))}.space-x-check>:not([hidden])~:not([hidden]){--tw-space-x-reverse:0;margin-right:calc(21px*var(--tw-space-x-reverse));margin-left:calc(21px*(1 - var(--tw-space-x-reverse)))}.bg-white{--tw-bg-opacity:1;background-color:rgba(255,255,255,var(--tw-bg-opacity))}.bg-blue-background{--tw-bg-opacity:1;background-color:rgba(232,237,243,var(--tw-bg-opacity))}.bg-blue-add{--tw-bg-opacity:1;background-color:rgba(51,166,186,var(--tw-bg-opacity))}.bg-gray-office-card{--tw-bg-opacity:1;background-color:rgba(152,158,167,var(--tw-bg-opacity))}.border-line{--tw-border-opacity:1;border-color:rgba(232,237,243,var(--tw-border-opacity))}.rounded-all{border-radius:8px}.rounded-input{border-radius:4px}.rounded-up{border-radius:8px 8px 0 0}.rounded-down{border-radius:0 0 8px 8px}.cursor-pointer{cursor:pointer}.flex{display:flex}.table{display:table}.flex-row{flex-direction:row}.flex-col{flex-direction:column}.items-center{align-items:center}.content-center{align-content:center}.justify-items-end{justify-items:end}.justify-center{justify-content:center}.justify-between{justify-content:space-between}.font-sans{font-family:ui-sans-serif,system-ui,-apple-system,Segoe UI,Roboto,Ubuntu,Cantarell,Noto Sans,sans-serif,BlinkMacSystemFont,\"Segoe UI\",\"Helvetica Neue\",Arial,\"Noto Sans\",\"Apple Color Emoji\",\"Segoe UI Emoji\",\"Segoe UI Symbol\",\"Noto Color Emoji\"}.font-bold{font-weight:700}.h-close{height:100px}.h-delete{height:0}.h-open{height:350px}.h-input{height:40px}.h-location{height:750px}.h-location-warning{height:860px}.h-button-location{height:70px}.h-navbar{height:80px}.text-header{font-size:24px}.text-sub-header{font-size:16px}.text-icon{font-size:18px}.text-button,.text-twelve{font-size:12px}.text-check{font-size:14px}.m-card{margin:25px 0 0}.m-line{margin:16px 0 19px!important}.m-line-location{margin:16px 0 24px!important}.m-title-location{margin:0 0 40px}.m-asterisk{margin:0 4px}.m-input{margin:0 0 24px}.m-warning{margin:2px 0 0}.m-delete{margin:0}.my-title{margin-top:48px;margin-bottom:48px}.opacity-0{opacity:0}.opacity-100{opacity:1}.focus-within\\:outline-none[focus-within]{outline:2px solid transparent;outline-offset:2px}.focus-within\\:outline-none:focus-within{outline:2px solid transparent;outline-offset:2px}.overflow-y-hidden{overflow-y:hidden}.p-card{padding:24px}.p-input{padding:10px 12px}.p-save{padding:8px 16px}.p-delete{padding:0}*{--tw-shadow:0 0 transparent}.shadow-sm{--tw-shadow:0 1px 2px 0 rgba(0,0,0,0.05)}.shadow-lg,.shadow-sm{box-shadow:0 0 transparent,0 0 transparent,var(--tw-shadow);box-shadow:var(--tw-ring-offset-shadow,0 0 transparent),var(--tw-ring-shadow,0 0 transparent),var(--tw-shadow)}.shadow-lg{--tw-shadow:0 10px 15px -3px rgba(0,0,0,0.1),0 4px 6px -2px rgba(0,0,0,0.05)}*{--tw-ring-inset:var(--tw-empty,/*!*/ /*!*/);--tw-ring-offset-width:0px;--tw-ring-offset-color:#fff;--tw-ring-color:rgba(147,197,253,0.5);--tw-ring-offset-shadow:0 0 transparent;--tw-ring-shadow:0 0 transparent}.focus-within\\:ring-2[focus-within],.ring-2{--tw-ring-offset-shadow:var(--tw-ring-inset) 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color);--tw-ring-shadow:var(--tw-ring-inset) 0 0 0 calc(2px + var(--tw-ring-offset-width)) var(--tw-ring-color);box-shadow:var(--tw-ring-offset-shadow),var(--tw-ring-shadow),0 0 transparent;box-shadow:var(--tw-ring-offset-shadow),var(--tw-ring-shadow),var(--tw-shadow,0 0 transparent)}.focus-within\\:ring-2:focus-within{--tw-ring-offset-shadow:var(--tw-ring-inset) 0 0 0 var(--tw-ring-offset-width) var(--tw-ring-offset-color);--tw-ring-shadow:var(--tw-ring-inset) 0 0 0 calc(2px + var(--tw-ring-offset-width)) var(--tw-ring-color);box-shadow:var(--tw-ring-offset-shadow),var(--tw-ring-shadow),0 0 transparent;box-shadow:var(--tw-ring-offset-shadow),var(--tw-ring-shadow),var(--tw-shadow,0 0 transparent)}.ring-input{--tw-ring-opacity:1;--tw-ring-color:rgba(152,158,167,var(--tw-ring-opacity))}.ring-danger{--tw-ring-opacity:1;--tw-ring-color:rgba(255,123,146,var(--tw-ring-opacity))}.focus-within\\:ring-input-blue[focus-within]{--tw-ring-opacity:1;--tw-ring-color:rgba(51,166,186,var(--tw-ring-opacity))}.focus-within\\:ring-input-blue:focus-within{--tw-ring-opacity:1;--tw-ring-color:rgba(51,166,186,var(--tw-ring-opacity))}.text-left{text-align:left}.text-black{--tw-text-opacity:1;color:rgba(0,0,0,var(--tw-text-opacity))}.text-white{--tw-text-opacity:1;color:rgba(255,255,255,var(--tw-text-opacity))}.text-blue-add,.text-blue-header{--tw-text-opacity:1;color:rgba(51,166,186,var(--tw-text-opacity))}.text-gray-office-card{--tw-text-opacity:1;color:rgba(152,158,167,var(--tw-text-opacity))}.text-danger{--tw-text-opacity:1;color:rgba(255,123,146,var(--tw-text-opacity))}.text-check{--tw-text-opacity:1;color:rgba(51,166,186,var(--tw-text-opacity))}.w-save{width:67px}.w-default{width:317px}.transform{--tw-translate-x:0;--tw-translate-y:0;--tw-rotate:0;--tw-skew-x:0;--tw-skew-y:0;--tw-scale-x:1;--tw-scale-y:1;transform:translateX(var(--tw-translate-x)) translateY(var(--tw-translate-y)) rotate(var(--tw-rotate)) skewX(var(--tw-skew-x)) skewY(var(--tw-skew-y)) scaleX(var(--tw-scale-x)) scaleY(var(--tw-scale-y))}.-rotate-180{--tw-rotate:-180deg}.transition{transition-property:background-color,border-color,color,fill,stroke,opacity,box-shadow,transform;transition-timing-function:cubic-bezier(.4,0,.2,1);transition-duration:.15s}.transition-opacity{transition-property:opacity;transition-timing-function:cubic-bezier(.4,0,.2,1);transition-duration:.15s}.ease-in-out{transition-timing-function:cubic-bezier(.4,0,.2,1)}.duration-500{transition-duration:.5s}@-webkit-keyframes spin{to{transform:rotate(1turn)}}@keyframes spin{to{transform:rotate(1turn)}}@-webkit-keyframes ping{75%,to{transform:scale(2);opacity:0}}@keyframes ping{75%,to{transform:scale(2);opacity:0}}@-webkit-keyframes pulse{50%{opacity:.5}}@keyframes pulse{50%{opacity:.5}}@-webkit-keyframes bounce{0%,to{transform:translateY(-25%);-webkit-animation-timing-function:cubic-bezier(.8,0,1,1);animation-timing-function:cubic-bezier(.8,0,1,1)}50%{transform:none;-webkit-animation-timing-function:cubic-bezier(0,0,.2,1);animation-timing-function:cubic-bezier(0,0,.2,1)}}@keyframes bounce{0%,to{transform:translateY(-25%);-webkit-animation-timing-function:cubic-bezier(.8,0,1,1);animation-timing-function:cubic-bezier(.8,0,1,1)}50%{transform:none;-webkit-animation-timing-function:cubic-bezier(0,0,.2,1);animation-timing-function:cubic-bezier(0,0,.2,1)}}", ""]);
// Exports
module.exports = exports;
...
exports = ___CSS_LOADER_API_IMPORT___(false);
// Module
exports.push([module.i, "body{--tw-bg-opacity:1;background-color:rgba(232,237,243,var(--tw-bg-opacity))}", ""]);
// Exports
module.exports = exports;
...
const _6622a9dd = () => interopDefault(__webpack_require__.e(/* import() | pages/index */ 1).then(__webpack_require__.bind(null, 41))); // TODO: remove in Nuxt 3
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./layouts/default.vue?vue&type=template&id=8ea66720&
var defaultvue_type_template_id_8ea66720_render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('nuxt')}
var defaultvue_type_template_id_8ea66720_staticRenderFns = []


// CONCATENATED MODULE: ./layouts/default.vue?vue&type=template&id=8ea66720&
...
var default_component = Object(componentNormalizer["a" /* default */])(
  script,
  defaultvue_type_template_id_8ea66720_render,
  defaultvue_type_template_id_8ea66720_staticRenderFns,
  false,
...
var fontawesome_svg_core_ = __webpack_require__(2);
...
var free_regular_svg_icons_ = __webpack_require__(16);

// CONCATENATED MODULE: ./.nuxt/templates.plugin.c10f6b56.js



fontawesome_svg_core_["config"].autoAddCss = false;

fontawesome_svg_core_["library"].add(free_solid_svg_icons_["faPlus"]);

fontawesome_svg_core_["library"].add(free_solid_svg_icons_["faChevronDown"]);

fontawesome_svg_core_["library"].add(free_solid_svg_icons_["faTimes"]);

fontawesome_svg_core_["library"].add(free_solid_svg_icons_["faPen"]);

fontawesome_svg_core_["library"].add(free_regular_svg_icons_["faTrashAlt"]);

fontawesome_svg_core_["library"].add(free_solid_svg_icons_["faExclamationCircle"]);

fontawesome_svg_core_["library"].add(free_solid_svg_icons_["faCheck"]);
...
/* Plugins */
 ...
 // Source: .\\templates.plugin.c10f6b56.js (mode: 'all')

 // Source: ..\\plugins\\vuemask.client.js (mode: 'client')
...
async function createApp(ssrContext, config = {}) {
  ...
  const app = {
    head: {
      "title": "dps-senior-frontend-test",
      "meta": [{
        "charset": "utf-8"
      }, {
        "name": "viewport",
  ...
  if (typeof /* Cannot get final name for export "default" in "./.nuxt/templates.plugin.c10f6b56.js" (known exports: , known reexports: ) */ undefined === 'function') {
    await /* Cannot get final name for export "default" in "./.nuxt/templates.plugin.c10f6b56.js" (known exports: , known reexports: ) */ undefined(app.context, inject);
  }
